...
def align_face(filepath, output_size=1024, transform_size=4096, enable_padding=True):
    ...
    :return: PIL Image
    """
    ensure_checkpoint_exists("/home/yai/Yaiverse/apiServer/yaiverse/inference/models/dlibshape_predictor_68_face_landmarks.dat")
    predictor = dlib.shape_predictor("/home/yai/Yaiverse/apiServer/yaiverse/inference/models/dlibshape_predictor_68_face_landmarks.dat")
