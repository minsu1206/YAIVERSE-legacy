...
def finetune(args):
    ...
    save_image(my_output,f'./{args.output_dir}/{img_name}_{style_name}_image_output.png')
    print(f'## random output image saved as ./{args.output_dir}/{style_name}_image_output.png!')
    
    if args.random_output == True : 
        output = torch.cat([original_sample, sample], 0)
        save_image(output,f'./{args.output_dir}/{img_name}_{style_name}_random_output.png')
